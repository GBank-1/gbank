...
public class Swagger2Config {
        ...
        private Map<HttpMethod, List<Response>> getDefaultResponses() {
                ...
                responses.put(HttpMethod.GET, Arrays.asList(
        ...
        @Bean
        public Docket gbankSApi() {
                return new Docket(DocumentationType.SWAGGER_2).groupName("bluebank").useDefaultResponseMessages(false)
                                .forCodeGeneration(false).pathMapping("/")
                                .tags(new Tag("clientes", ""), new Tag("transferencias", ""), new Tag("contas", ""))
                                .select().apis(RequestHandlerSelectors.basePackage(BR_GBANK_GBANK_RESOURCES))
        ...
        private ApiInfo apiInfo() {
                return new ApiInfoBuilder().title("GBANK REST API")
                                ...
                                .version("1.0.0").license("MIT License").build();
        }
